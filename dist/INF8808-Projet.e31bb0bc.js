...
function build(div, data, startDate, endDate) {
  ...
  svg.datum(res).append("g").attr("id", "groups").selectAll("g").data(function (d) {
    ...
    return colors[i];
  }).style("stroke", "black").attr("d", d3.arc().innerRadius(innerRadius).outerRadius(outerRadius)).on("mouseover", function (_, d) {
...
function highlightGroup(eventData, links) {
  links.filter(function (d) {
    return d.source.index != eventData.index;
  }).attr("opacity", 0.1);
}
...
},{"./scripts/onglet1.js":"scripts/onglet1.js","./scripts/heatmap.js":"scripts/heatmap.js","./scripts/chord.js":"scripts/chord.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
